...
import InfoCarousel from "./InfoCarousel"; // Import InfoCarousel component
import HistoryMap from "./HistoryMap"; // Import HistoryMap component
...
const HistorySection = () => {
  return (
    ...
    >
      ...
      <InfoCarousel /> {/* Include InfoCarousel component */}
      <HistoryMap /> {/* Include HistoryMap component */}
